      ...
      <div className='container mx-auto px-4 max-w-7xl'>
        ...
        <div className='text-center space-y-4 mb-20'>
          ...
          <p className='text-xl text-gray-600'>
            180+ Countries and More Added Every Month!
          </p>
        ...
        <div className='grid md:grid-cols-4 gap-8 mb-20'>
          {/* Free Tier */}
          <Card className='relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:bg-[#a2d8f3]'>
            <CardHeader className='text-center pb-0'>
              <div className='w-16 h-16 mx-auto bg-[#cbe5fa]  rounded-full flex items-center justify-center mb-4'>
                <Users className='w-8 h-8 text-[#1b6cae]' />
              </div>
          ...
          <Card className='relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:bg-[#a2d8f3]'>
            <CardHeader className='text-center pb-0'>
              <div className='w-16 h-16 mx-auto bg-[#cbe5fa]  rounded-full flex items-center justify-center mb-4'>
                <Rocket className='w-8 h-8 text-[#1b6cae]' />
              </div>
          ...
          {/* SME Tier */}
          <Card className='relative overflow-hidden transition-all duration-300 hover:shadow-lg border-[#a2d8f3]'>
            ...
            <CardHeader className='text-center pb-0'>
              <div className='w-16 h-16 mx-auto bg-[#cbe5fa]  rounded-full flex items-center justify-center mb-4'>
                <Building2 className='w-8 h-8 text-[#1b6cae]' />
              </div>
          ...
          <Card className='relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:bg-[#a2d8f3]'>
            <CardHeader className='text-center pb-0'>
              <div className='w-16 h-16 mx-auto bg-[#cbe5fa]  rounded-full flex items-center justify-center mb-4'>
                <Building className='w-8 h-8 text-[#1b6cae]' />
              </div>
        ...
        <div className='text-center space-y-4'>
          ...
          <Button
            variant='outline'
            size='lg'
            className='mx-auto hover:bg-[#1d94d0]'
          >
