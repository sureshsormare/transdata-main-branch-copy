    ...
    <div className='min-h-screen bg-gradient-to-b from-gray-50 to-white py-20'>
      <div className='container mx-auto px-4 max-w-7xl'>
        ...
        <div className='grid md:grid-cols-4 gap-8 mb-20'>
          {/* Free Tier */}
          <Card className='relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-violet-500'>
            ...
            <CardContent className='text-center pt-6'>
              <Button
                className='w-full hover:bg-violet-700 hover:text-white'
                variant='outline'
              >
                Sign Up Free
              </Button>
          ...
          <Card className='relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:border-violet-500'>
            ...
            <CardContent className='text-center space-y-4 pt-6'>
              <Button className='w-full hover:bg-violet-700 hover:text-white'>
                Sign Up
              </Button>
        ...
        <div className='text-center space-y-4'>
          ...
          <Button
            variant='outline'
            size='lg'
            className='mx-auto hover:bg-violet-600'
          >
