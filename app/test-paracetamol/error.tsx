...
export default function TestParacetamolError({
  error,
  reset,
}: {
  ...
  useEffect(() => {
    ...
    console.error('Test Paracetamol Error:', error);
  }, [error]);
    ...
    <div className="min-h-screen bg-gray-50 flex items-center justify-center">
      <div className="max-w-md w-full bg-white rounded-lg shadow-lg p-6">
        <div className="text-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900 mb-2">Test Page Error</h2>
