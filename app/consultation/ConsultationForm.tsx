...
import { FaBuilding, FaEnvelope, FaPhone, FaUser, FaCalendar, FaClock, FaGlobe } from "react-icons/fa"
...
const consultationFormSchema = z.object({
  ...
  businessChallenge: z.string().min(10, "Please describe your business challenge"),
})
...
export function ConsultationForm() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      console.log("Sending consultation request:", validatedData)
      ...
      const response = await fetch("/api/contact", {
        ...
        body: JSON.stringify({
          ...validatedData,
          message: `Consultation Request - ${validatedData.businessChallenge}`,
      ...
      if (!response.ok) {
        ...
        throw new Error(result.error || `Failed to schedule consultation (Status: ${response.status})`)
      }

      if (result.success) {
        setSuccessMessage("Thank you! Your consultation request has been submitted successfully. Our expert team will contact you within 24 hours to schedule your personalized consultation session.")
        setFormData({
          name: "",
          email: "",
          organization: "",
  ...
  return (
    <div className="flex flex-col justify-center">
      ...
      >
        ...
        {/* Row 3 - Industry and Consultation Type */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="space-y-2">
          ...
          <div className="space-y-2">
            <Label htmlFor="consultationType" className="text-[#1b6cae]">
              Consultation Type *
            </Label>
            <div className="relative">
              <select
                ...
                onChange={handleInputChange}
                className={`w-full px-3 py-3 border border-gray-200 rounded focus:ring-2 focus:ring-blue-200 outline-none transition ${
                  errors.consultationType ? "border-red-500 focus:ring-red-500" : ""
                }`}
                required
              ...
              >
                ...
                <option value="Supplier Identification">Supplier Identification</option>
                <option value="Pricing Optimization">Pricing Optimization</option>
            ...
            {errors.consultationType && (
              <p id="consultationType-error" className="text-sm text-red-600">
                {errors.consultationType}
              </p>
            )}
          </div>
        ...
        {/* Row 5 - Business Challenge */}
        <div className="space-y-2">
          <Label htmlFor="businessChallenge" className="text-[#1b6cae]">
          ...
          <div className="relative">
            <textarea
              ...
              className={`w-full px-3 py-3 border border-gray-200 rounded focus:ring-2 focus:ring-blue-200 outline-none transition resize-none ${
                errors.businessChallenge ? "border-red-500 focus:ring-red-500" : ""
              }`}
              placeholder="Tell us about your specific business challenges, goals, or what you hope to achieve through our consultation..."
              required
              aria-describedby={errors.businessChallenge ? "businessChallenge-error" : undefined}
            />
          </div>
          {errors.businessChallenge && (
            <p id="businessChallenge-error" className="text-sm text-red-600">
              {errors.businessChallenge}
            </p>
          )}
        </div>
        ...
        <div className="bg-purple-50 p-4 rounded-lg border border-purple-200">
          <div className="flex items-start gap-3">
            ...
            <div className="text-sm text-purple-800">
              <p className="font-semibold mb-1">Consultation Terms:</p>
              <ul className="space-y-1 text-xs">
                <li>• Free initial consultation (30-45 minutes)</li>
                <li>• Expert advice from industry specialists</li>
                <li>• Personalized recommendations and strategies</li>
                <li>• No obligations or pressure to purchase</li>
                <li>• Follow-up resources and materials provided</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div className="flex justify-end">
          <Button
            type="submit"
            disabled={isLoading}
            className="bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700 text-white px-8 py-3 rounded-full font-semibold shadow-lg transition-all duration-300 transform hover:scale-105"
          >
            {isLoading ? (
              ...
              <>
                Schedule Consultation <BiRightArrow />
              </>
            )}
          </Button>
        </div>
